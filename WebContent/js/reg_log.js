$(document).ready(function(){
	...
	$("#login_form").submit(function(){
		...
		$.post("AjaxServlet",
				{username:lousername,password:lopassword,method:"login"},
				function(data){
					if(data){
						$(".login_warning").show();
						setTimeout(function(){$(".login_warning").hide("slow")},2000);
						flag=false;
					}				
				}
		);
		...
		if(flag){
			setCookie(lousername,lopassword,$("#bcdl").attr("checked"));
		}
		return flag;
	});
